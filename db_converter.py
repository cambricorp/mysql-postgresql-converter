...
def parse(input_filename, output_filename):
    ...
    output.write("CREATE EXTENSION IF NOT EXISTS citext;\n")
    ...
    for i, line in enumerate(input_fh):
        ...
        if current_table is None:
            ...
            # Inserting data into a table?
                ...
                line = re.sub(r"([^'])'0000-00-00 00:00:00'", r"\1NULL", line)
                line = re.sub(r"([^'])'0000-00-00'", r"\1NULL", line)
            ...
            if line.startswith('"'):
                ...
                if type == "tinyint(1)":
                    ...
                    if enum_name not in enum_types:
                        output.write("DROP TYPE IF EXISTS {0} CASCADE; \n".format(enum_name));
